...
async function getData(page: string, sort: SortOption) {
  ...
  const orderByClause = sort === 'recent'
    ...
    : [{ netVoteScore: Prisma.SortOrder.desc }, { createdAt: Prisma.SortOrder.desc }]; // Sort by netVoteScore then by createdAt
    ...
    <div className="max-w-[1000px] mx-auto flex gap-x-10 mt-4 mb-10">
      <div className="w-[65%] flex flex-col gap-y-5">
        ...
        <Suspense fallback={<SuspenseCard />} key={`${currentPage}-${sortToUse}`}>
          <ShowItems searchParams={{ page: currentPage, sort: sortToUse }} userId={user?.id} />
        </Suspense>
      </div>
      ...
      <div className="w-[35%] ">
        <Card>
          ...
          <div className="p-2">
            ...
            Hey Binusian! Welcome to BFriends – your campus spaceport. Explore BHubs, launch your thoughts, share discoveries and connect with your crew!
            </p>
            ...
            <div className="flex flex-col gap-y-3">
              <Button variant="secondary" asChild>
                <Link href="/p/PublicSphere/create">Create Post in PublicSphere</Link>
              </Button>
              <Button asChild>
